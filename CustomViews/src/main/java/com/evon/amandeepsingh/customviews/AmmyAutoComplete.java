 ...
 */
public class AmmyAutoComplete extends AutoCompleteTextView implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    public AmmyAutoComplete(Context context) {
        super(context, null);
        init(context);
    }


    public AmmyAutoComplete(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public AmmyAutoComplete(Context context, AttributeSet attrs, int defStyleAttr) {
