 ...
 */
public class AmmyCircularImageView extends ImageView {
    // For logging purposes
    private static final String TAG = AmmyCircularImageView.class.getSimpleName();
    ...
    // Border and Selector configuration variables
    ...
    public AmmyCircularImageView(Context context) {
        this(context, null, R.styleable.CircularImageViewStyle_circularImageViewDefault);
    }

    public AmmyCircularImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CircularImageViewStyle_circularImageViewDefault);
    }

    public AmmyCircularImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AmmyCircularImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
